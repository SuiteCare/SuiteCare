...
const MateManageSidebar = ({ activeMenu }) => {
  return (
    <div className={styles.Sidebar}>
      <h3>내 활동 관리</h3>
      <div className={`${styles.menu} ${activeMenu === 'targeting' ? styles.active : ''}`}>
        <Link href='/mate/manage/targeting'>나에게 들어온 신청</Link>
      </div>
      <div className={`${styles.menu} ${activeMenu === 'application' ? styles.active : ''}`}>
        <Link href='/mate/manage/application'>공고 지원 목록</Link>
      </div>
